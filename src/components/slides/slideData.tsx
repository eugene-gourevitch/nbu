              ...
              <div className="space-y-5">
                {[
                  ...
                  <div key={i} className="flex items-start gap-4">
                    ...
                    <p className="text-[22px] text-slide-muted leading-relaxed">{q}</p>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="bg-slide-surface rounded-sm p-7 flex flex-col overflow-hidden anim-fade-up stagger-3">
              ...
              <div className="space-y-4 overflow-hidden">
                ...
                <div>
                  ...
                  <p className="text-[19px] text-slide-muted leading-relaxed">JP Morgan Chase, Citibank, Standard Chartered, Deutsche Bank, Natixis, SMBC</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-slide-surface rounded-sm p-8 flex flex-col anim-scale-in stagger-2">
              <div className="flex items-center gap-5 mb-6">
                ...
                <div>
                  ...
                  <p className="text-[19px] text-slide-primary font-semibold">Foreign Investor</p>
                </div>
              </div>
            ...
            <div className="bg-slide-surface rounded-sm p-8 flex flex-col anim-scale-in stagger-4">
              <div className="flex items-center gap-5 mb-6">
                ...
                <div>
                  ...
                  <p className="text-[19px] text-slide-primary font-semibold">NBU Chairman</p>
                </div>
              </div>
              <ul className="space-y-3">
                {[
                  ...
                  {steps.map((step, i) => (
                    <div key={step.date} className="flex flex-col items-center text-center">
                      ...
                      <div style={{ animation: `slide-up 0.4s ease-out ${0.6 + i * 0.35}s both` }}>
                        ...
                        <p className="mt-3 text-[19px] text-slide-muted leading-relaxed max-w-[360px]">{step.desc}</p>
                      </div>
                    </div>
                  ))}
                </div>
    ...
    component: (props) => (
      <SlideLayout variant="white" slideNumber={props.slideNumber} totalSlides={props.totalSlides}>
        <div className="flex flex-col h-full p-[80px]">
          ...
          <p className="text-[19px] text-slide-muted leading-relaxed mb-8 max-w-[1200px]">
          ...
          <div className="anim-slide-right stagger-3">
            ...
            <ul className="space-y-5">
              {[
                ...
                <li key={item} className="text-[22px] text-slide-muted leading-relaxed flex items-start gap-3" style={{ animation: `fade-in 0.3s ease-out ${0.5 + i * 0.1}s both` }}>
